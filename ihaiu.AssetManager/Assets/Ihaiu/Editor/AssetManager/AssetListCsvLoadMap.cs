...
namespace com.ihaiu
{
    ...
    {
        public static void Generator(bool isDevelop = false)
        {
            string filesPath = isDevelop ? AssetManagerSetting.EditorStreamFilePath.AssetListLoadMap : AssetManagerSetting.EditorWorkspaceFilePath.AssetListLoadMap;
            ...
            AssetListCsvDontUnload.Generator(isDevelop);
        }
