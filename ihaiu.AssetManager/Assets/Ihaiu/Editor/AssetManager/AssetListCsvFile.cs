...
namespace com.ihaiu
{
	public class AssetListCsvFile 
	{
        ...
        public static void Generator()
        {
            ...
            string filecsv = AssetManagerSetting.EditorWorkspaceFilePath.AssetListFile;
            ...
            others.Add(AssetManagerSetting.EditorWorkspaceFilePath.AssetListLoadMap);
            others.Add(AssetManagerSetting.EditorWorkspaceFilePath.AssetListDontUnload);
        ...
        public static void CopyStreamFilesCsvToVersion(Version version)
        {
            ...
            File.Copy(AssetManagerSetting.EditorWorkspaceFilePath.AssetListFile, path);
        }
        ...
        public static void GeneratorUpdateList(Version appVer)
        {
            ...
            string path = AssetManagerSetting.EditorWorkspaceFilePath.AssetListUpdate;
            Debug.Log(path);
            PathUtil.CheckPath(path);
            ...
            AssetFileList curr = AssetFileList.Read(AssetManagerSetting.EditorWorkspaceFilePath.AssetListFile);
