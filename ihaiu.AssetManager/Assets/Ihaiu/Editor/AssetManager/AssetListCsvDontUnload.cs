...
namespace com.ihaiu
{
    public class AssetListCsvDontUnload 
    {
        ...
        {
            string filesPath = isDevelop ? AssetManagerSetting.EditorStreamFilePath.AssetListDontUnload : AssetManagerSetting.EditorWorkspaceFilePath.AssetListDontUnload;
